package com.project.gestiondestock.config;
...
/**
 * cette configuration elle sera executé 1 seul fois (aprés la config la classe peuvent etre supprimée/ ou commenter @Configuration)
 * avec @Value : la valeur de flickr.apiKey va etre injecter automatiquement dans apiKey
 */
...
/*
    ...
    /*
    * lors du demarrage de l'app  ce bean va etre execute automatiquement
    */
